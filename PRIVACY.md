...
## What data the NetRouse app might collect, store and process

The app only records data strictly necessary for the app to function. This
includes for example the app settings and local servers. The app does not
include any advertisement libraries or any 3rd party tracking (analytics) code,
such as Google Analytics.

The NetRouse app needs to be connected to a NetRouse server for full functionality
and the app may share data with this server. After the app is launched, you
can set a NetRouse server URL. You, as a user, are responsible for verifying that
you can trust this server instance.

For best privacy, you should host NetRouse server yourself, as then only you have
access to your data.
...
## What data the NetRouse team may have access to

The developers of NetRouse do **not** have access to any of your information,
except when you
...
This Privacy Policy was last updated on 2026-09-21, If you have questions, open
an issue on GitHub.
